...
(defun yelang/js2-which-function ()
  ...
  (let* (
    ...
    (if (string-equal ξfSuffix "el") ; special case for emacs lisp
      ...
      (if ξprog-name
          (progn
            (message "Running…")
            (async-shell-command ξcmd-str "*yelang/run-current-file output*"))
...
(defun yelang/impatient-mode-hook ()
...
(defun my-setup-develop-environment ()
  (interactive)
  (when (my-project-name-contains-substring "yelang")
    (cond
