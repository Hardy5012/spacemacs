...
(defun yelang-better-defaults/post-init-recentf ()
  (progn
...
(defun yelang-better-defaults/init-dired-mode ()
  (use-package dired-mode
    ...
    (progn
      ...
      (evilified-state-evilify-map dired-mode-map
        :mode dired-mode
        :bindings
        (kbd "C-k") 'yelang/dired-up-directory
...
(defun yelang-better-defaults/init-profiler ()
