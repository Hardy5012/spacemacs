...
(global-set-key [(shift return)] 'yelang/smart-open-line)
;; 自动补全
...
(define-key global-map (kbd "<f8>") 'yelang/show-current-buffer-major-mode)
...
(global-set-key (kbd "s-d") 'yelang/my-mc-mark-next-like-this)
(bind-key* "s-r" 'mc/reverse-regions)
(global-set-key (kbd "<f5>") 'yelang/run-current-file)
...
(when (spacemacs/system-is-mac)
 (spacemacs/set-leader-keys "o!" 'yelang/iterm-shell-command))
...
;; (bind-key* "s-r" 'yelang/browser-refresh--chrome-applescript)
(bind-key* "s-;" 'yelang/insert-semicolon-at-the-end-of-this-line)
(bind-key* "C-s-;" 'yelang/delete-semicolon-at-the-end-of-this-line)
(bind-key* "s-," 'yelang/insert-comma-at-the-end-of-this-line)
;; (bind-key* "C-s-," 'yelang/delete-comma-at-the-end-of-this-line)
(bind-key* "C-c l" 'yelang/insert-chrome-current-tab-url)
;; (bind-key* "M-s o" 'occur-dwim)
(bind-key* "C-=" 'er/expand-region)
(bind-key* "M--" 'yelang/goto-match-paren)
...
(global-set-key (kbd "<f1>") 'yelang/helm-hotspots)
...
(spacemacs/set-leader-keys "fR" 'yelang/rename-file-and-buffer)
...
(spacemacs/set-leader-keys "or" 'yelang/browser-refresh--chrome-applescript)
...
(spacemacs/set-leader-keys "sj" 'yelang/counsel-imenu)
;; deal with BOM
...
(spacemacs/set-leader-keys "os" 'yelang/search-in-fireball)
