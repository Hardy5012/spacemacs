...
;; (defun yelang/octopress-rake (command)
;;   "run rake commands"
...
;; (defun yelang/octopress-qrsync (command)
;;   (let ((command-str (format "/usr/local/bin/qrsync %s" command )))
;;     (shell-command-to-string command-str)))

;; (defun yelang/octopress-generate ()
;;   "generate jekyll site"
;;   (interactive)
;;   (yelang/octopress-rake "generate")
;;   (message "Generate site OK"))

;; (defun yelang/octopress-deploy ()
;;   "default deploy task"
;;   (interactive)
;;   (yelang/octopress-rake "deploy")
;;   (yelang/octopress-qrsync "/Users/guanghui/4gamers.cn/guanghui.json")
;;   (message "Deploy site OK"))

;; (defun yelang/octopress-gen-deploy ()
;;   "generate website and deploy"
;;   (interactive)
;;   (yelang/octopress-rake "gen_deploy")
;;   (yelang/octopress-qrsync "/Users/guanghui/4gamers.cn/guanghui.json")
;;   (message "Generate and Deploy OK"))

;; (defun yelang/octopress-upimg ()
;;   (interactive)
;;   (yelang/octopress-qrsync "/Users/guanghui/4gamers.cn/guanghui.json")
;;   (message "Up Img to Qiniu"))

;; (defun yelang/directory-parent (directory)
;;   (let ((parent (file-name-directory (directory-file-name directory))))
;;     (if (not (equal directory parent))
;;         parent)))

(defun yelang/jekyll-serve ()
  (interactive)
  (let* ((default-directory
           (if (string-match "_posts/$" default-directory)
               (yelang/directory-parent (yelang/directory-parent default-directory))
             (yelang/directory-parent default-directory)))
...
(defun yelang/org-archive-cancel-tasks ()
  (interactive)
  (org-map-entries
   (lambda ()
     (org-archive-subtree)
...
(defun yelang/skip-non-stuck-projects ()
