...
(defun yelang-org/init-blog-admin ()
...
(defun yelang-org/post-init-org-pomodoro ()
  (progn
    (add-hook 'org-pomodoro-finished-hook '(lambda () (yelang/growl-notification "Pomodoro Finished" "☕️ Have a break!" t)))
    (add-hook 'org-pomodoro-short-break-finished-hook '(lambda () (yelang/growl-notification "Short Break" "������ Ready to Go?" t)))
    (add-hook 'org-pomodoro-long-break-finished-hook '(lambda () (yelang/growl-notification "Long Break" " ������ Ready to Go?" t)))
    ))

;;In order to export pdf to support Chinese, I should install Latex at here: https://www.tug.org/mactex/
;; http://freizl.github.io/posts/2012-04-06-export-orgmode-file-in-Chinese.html
;;http://stackoverflow.com/questions/21005885/export-org-mode-code-block-and-result-with-different-styles
(defun yelang-org/post-init-org ()
      ...
      (setq org-capture-templates
            '(("t" "Todo" entry (file+headline org-agenda-file-gtd "Workspace")
              ...
              ("c" "Chrome" entry (file+headline org-agenda-file-note "Quick notes")
               "* TODO [#C] %?\n %(yelang/retrieve-chrome-current-tab-url)\n %i\n %U"
               :empty-lines 1)
...
(defun yelang-org/init-org-mac-link ()
...
(defun yelang-org/post-init-ox-reveal ()
  (setq org-reveal-root "file:///Users/guanghui/.emacs.d/reveal-js"))


(defun yelang-org/init-org-tree-slide ()
  (use-package org-tree-slide
    :init
    (spacemacs/set-leader-keys "oto" 'org-tree-slide-mode)))


(defun yelang-org/init-org-download ()
  (use-package org-download
    :defer t
    :init
    (org-download-enable)))

(defun yelang-org/init-plain-org-wiki ()
  (use-package plain-org-wiki
    :init
    (setq pow-directory "~/org-notes")))

(defun yelang-org/init-worf ()
  (use-package worf
    :defer t
    :init
    (add-hook 'org-mode-hook 'worf-mode)))

(defun yelang-org/post-init-deft ()
  (progn
