...
(defun yelang-ui/init-zilong-mode-line ()
  (defun yelang/display-mode-indent-width ()
  ...
  (setq-default mode-line-format
                (list
                 ...
                 '(:eval (yelang/display-mode-indent-width))
                 ;; line and column
...
(defun yelang-ui/post-init-diminish ()
  (progn
...
(defun yelang-ui/post-init-spaceline ()
...
(defun yelang-ui/init-evil-vimish-fold ()
...
(defun yelang-ui/post-init-hl-anything ()
  (progn
...
(defun yelang-ui/post-init-pangu-spacing ()
  (progn
    ;; add toggle options
...
(defun yelang-ui/post-init-popwin ()
  (progn
    (push "*yelang/run-current-file output*" popwin:special-display-config)
    (delete "*Async Shell Command*" popwin:special-display-config)))

(defun yelang-ui/post-init-whitespace ()
  (progn
